...
class SensorDataTest extends RestApiTestCase
{
    ...
    public function testGetAll()
    {
        ...
        $this->assertSame(1.1, $sensordata[0]->data);
        ...
        $this->assertSame(2.22, $sensordata[1]->data);
        ...
        $this->assertSame(3.333, $sensordata[2]->data);
        ...
        $this->assertSame(4.4444, $sensordata[3]->data);
        ...
        $this->assertSame(5.55555, $sensordata[4]->data);
        ...
        $this->assertSame(6.666666, $sensordata[5]->data);
    ...
    public function testGetById()
    {
        ...
        $this->assertSame(1.1, $sensordata->data);
    ...
    {
        $response = $this->doHttpPostRequest("UnitTestUser1/sensordata", '{"id":null,"data":9444.4,"timestamp":null,"sensorid":999999996}');
        ...
        $this->assertSame(9444.4, $sensordata->data);
        $this->assertSame(999999996, $sensordata->sensorid);
    }
